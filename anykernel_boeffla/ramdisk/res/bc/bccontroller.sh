...
KERNEL_SPECS="oneplus2;cm;cm14.0;http://kernel.boeffla.de/oneplus2/boeffla-kernel-cm/"
...
if [ "apply_system_tweaks" == "$1" ]; then
	...
	if [ "Thermal - Relaxed" == "$2" ]; then
		...
		cp /res/thermal/thermal-engine-relaxed.conf /system/etc/thermal-engine-8994.conf
		chmod 644 /system/etc/thermal-engine-8994.conf
		busybox sync
	...
	if [ "Thermal - Performance" == "$2" ]; then
		mount -o remount,rw -t ext4 $SYSTEM_DEVICE /system
		cp /res/thermal/thermal-engine-performance.conf /system/etc/thermal-engine-8994.conf
		chmod 644 /system/etc/thermal-engine-8994.conf
		busybox sync
		mount -o remount,ro -t ext4 $SYSTEM_DEVICE /system
		busybox sync
	...
	if [ "Thermal - Gaming" == "$2" ]; then
		mount -o remount,rw -t ext4 $SYSTEM_DEVICE /system
		cp /res/thermal/thermal-engine-gaming.conf /system/etc/thermal-engine-8994.conf
		chmod 644 /system/etc/thermal-engine-8994.conf
		busybox sync
		mount -o remount,ro -t ext4 $SYSTEM_DEVICE /system
		busybox sync
	...
	if [ "Thermal - Extreme" == "$2" ]; then
		mount -o remount,rw -t ext4 $SYSTEM_DEVICE /system
		cp /res/thermal/thermal-engine-extreme.conf /system/etc/thermal-engine-8994.conf
		chmod 644 /system/etc/thermal-engine-8994.conf
		busybox sync
		mount -o remount,ro -t ext4 $SYSTEM_DEVICE /system
		busybox sync
	...
	mount -o remount,rw -t ext4 $SYSTEM_DEVICE /system
	cp /res/thermal/thermal-engine-8994.conf /system/etc/thermal-engine-8994.conf
	chmod 644 /system/etc/thermal-engine-8994.conf
	busybox sync
	mount -o remount,ro -t ext4 $SYSTEM_DEVICE /system
	busybox sync
