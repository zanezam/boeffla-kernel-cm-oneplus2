...
#
# (C) Lord Boeffla (aka andip71), 10.03.2016
...
MKBOOTIMG_CMDLINE="androidboot.hardware=qcom user_debug=31 msm_rtb.filter=0x37 ehci-hcd.park=3 lpm_levels.sleep_disabled=1 boot_cpus=0-5"
